...
PRESENTERS: dict[str, Presenter] = {
    ...
    "tx.snapshot": generic_payload_panel(_generic_title("tx.snapshot")),
    "tx.reclassify": lambda data: transaction_summary(data, title="Transaction reclassified"),
    ...
    "system.status": generic_payload_panel(_generic_title("system.status")),
    "user.create": user_summary,
    "user.list": user_list,
    "category.create": category_summary,
    "category.ensure": category_summary,
    "category.list": category_list,
    "category.find": category_list,
    "category.show": category_summary,
    "category.update": category_summary,
    ...
    "payment.instrument.create": generic_payload_panel(_generic_title("payment.instrument.create")),
    "payment.instrument.list": generic_payload_panel(_generic_title("payment.instrument.list")),
    "payment.instrument.show": generic_payload_panel(_generic_title("payment.instrument.show")),
    "payment.profile.create": generic_payload_panel(_generic_title("payment.profile.create")),
    "payment.profile.list": generic_payload_panel(_generic_title("payment.profile.list")),
    "payment.profile.status": generic_payload_panel(_generic_title("payment.profile.status")),
