...
from .presenter_catalog import (
    ...
    posting_semantics_audit_summary,
    posting_semantics_cutover_plan_summary,
    posting_semantics_write_summary,
    summary_accounts,
    summary_categories,
    user_list,
    user_summary,
...
PRESENTERS: dict[str, Presenter] = {
    ...
    "system.posting_semantics.audit": posting_semantics_audit_summary,
    "system.posting_semantics.cutover_plan": posting_semantics_cutover_plan_summary,
    "system.posting_semantics.resolve": posting_semantics_write_summary,
    "system.posting_semantics.rewrite": posting_semantics_write_summary,
    ...
    "counterparty.create": generic_payload_panel(_generic_title("counterparty.create")),
    "counterparty.ensure": generic_payload_panel(_generic_title("counterparty.ensure")),
    "counterparty.list": generic_payload_panel(_generic_title("counterparty.list")),
    "counterparty.show": generic_payload_panel(_generic_title("counterparty.show")),
    "credit_card.list": credit_card_list,
    "credit_card.show": credit_card_summary,
    "credit_card.update": credit_card_summary,
    "financial_account.list": financial_account_list,
    "financial_account.show": financial_account_summary,
    "financial_account.balance": account_balance_summary,
