...
from .auth_pages import _error, _page
...
def device_approve(
    ...
    try:
        ...
        grant = platform_key_exchange.approve_device_user_code(user_code, actor, action, service.storage)
...
def _device_form(*, user_code: str, csrf_token: str, error: str | None, status_code: int = 200) -> HTMLResponse:
    body = f"""
      <section class="panel">
        ...
        <p class="muted">Enter the code shown in your terminal.</p>
        {_error(error)}
